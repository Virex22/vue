      ...
      <div class="w-full flex items-center justify-center font-sans">
        <div class="bg-white rounded shadow p-6 m-4 w-full lg:w-3/4 lg:max-w-lg overflow-y-auto">
          <div class="mb-4">
              ...
              <add-input @onSaveTodo="addTodo" > </add-input >
          </div>
          <div class="mb-5">
            <progress-input :progress="progressPct" ></progress-input>
          </div>
          <div>
            <div class="flex mb-4 items-center" v-for="todo in paginatedTodos" :key="todo.id">
                    ...
                    <button
                        ...
                        :class="{
                        'text-gray-500 border-gray-500 hover:bg-gray-500': todo.done,                                'text-green-500 border-green-500 hover:bg-green-500': !todo.done
                        }"
...
export default {
    ...
    computed: {
        ...
        availablePages() {
            ...
            console.log(max);
            if (this.page - 3 > 0)
                pages.unshift(this.page - 3);
            if (this.page - 2 > 0)
                pages.unshift(this.page - 2);
            if (this.page - 1 > 0)
                pages.unshift(this.page - 1);
    ...
    components: { AddInput, ProgressInput }
}
</script>